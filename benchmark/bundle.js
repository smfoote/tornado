...
},{"../dist/compiler":3,"../dist/parser":17,"../dist/runtime":18,"./templates":2}],2:[function(require,module,exports){
...
module.exports = {
  templates: [
    ...
    {
      name: 'blocks',
      str: "<div id=\"container\">\n  <h3 class=\"header\">Blocks</h3>\n  <p>This is a template with a {+block/} and another {+block2}with default content{/block2}</p>\n</div>\n{<block}inline partial{/block}\n{<block2}overridden block{/block2}\n",
      data: {}
    },
    {
      name: 'exists',
      str: "<div id=\"container\">\n  <h3 class=\"{?isHeader}header{/isHeader}\">Exists</h3>\n  <p>This is a template with a {?exists}tornado exists body{/exists} and another {^notExists}not exists body with a child {?exists}exists body{/exists}{/notExists}</p>\n</div>\n",
      data: {
        isHeader: true,
        exists: true,
        notExists: true
    ...
    {
      name: 'partial',
      str: "<div id=\"container\">\n  <h3 class=\"header\">Exists</h3>\n  <p>This is a template with a partial: {>search/} and another {>results/}</p>\n</div>\n",
      data: {}
    },
    {
      name: 'reference',
      str: "<div id=\"container\">\n  <h3 class=\"{?isHeader}header{/isHeader}\">Exists</h3>\n  <p>This is a template with a {?exists}tornado exists body with {ref}{/exists} and another {^notExists}not exists body {references} all {over} the {place} with a child {?exists}exists body{/exists}{/notExists}</p>\n</div>\n",
      data: {
        isHeader: true,
        exists: true,
        notExists: false,
    ...
    {
      name: 'section',
      str: "<div id=\"container\">\n  <h3 class=\"{#classes}{.}{/classes}\">Exists</h3>\n  <p>This is a template with a {#section}tornado section body{/section} and another {#items}section body with a child {?exists}exists body{/exists}{/items}</p>\n</div>\n",
      data: {}
    }
  ]
};

},{"fs":19}],3:[function(require,module,exports){
"use strict";
...
},{"./compiler/context":5,"./compiler/passes/adjustAttrs":6,"./compiler/passes/buildInstructions":7,"./compiler/passes/escapableRaw":8,"./compiler/passes/generateJS":9,"./compiler/passes/htmlEntities":10,"./compiler/passes/postprocess":11}],4:[function(require,module,exports){
"use strict";
/**
...
},{"../visitor":16}],7:[function(require,module,exports){
"use strict";
...
},{"../utils/Instruction":12,"../visitor":16}],8:[function(require,module,exports){
"use strict";
...
},{"../utils/builder":13,"../visitor":16}],9:[function(require,module,exports){
/* eslint camelcase: 0 */
"use strict";
...
},{"../codeGenerator":4,"../utils/builder":13}],10:[function(require,module,exports){
"use strict";
...
},{"../utils/hexDecHTMLEntities":14,"../utils/namedHTMLEntities":15,"../visitor":16}],11:[function(require,module,exports){
"use strict";
...
},{"../utils/builder":13}],12:[function(require,module,exports){
"use strict";
