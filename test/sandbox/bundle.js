...
var compiler = {
  ...
  buildElementAttributes: function buildElementAttributes(elType) {
    ...
    attributes.forEach(function (attr) {
      ...
      attr.attrName = _this.adjustAttrName(elType, attr.attrName);
      if (hasRef) {
  ...
  HTML_ELEMENT: function HTML_ELEMENT(node) {
    ...
    var namespace = this.context.namespace ? ", '" + this.context.namespace + "'" : "";
  ...
  tornadoBodies: {
    exists: function exists(node, reverse) {
      ...
      var indexHash = indexes.join("");
      var containerName = this.getElContainerName();
      var hasElseBody = node.bodies.length === 1 && node.bodies[0][1].name === "else";
      if (this.context.state !== STATES.HTML_ATTRIBUTE) {
    ...
    section: function section(node) {
      ...
      var indexHash = indexes.join("");
      var hasElseBody = node.bodies.length === 1 && node.bodies[0][1].name === "else";
      var isInHtmlAttribute = this.context.state === STATES.HTML_ATTRIBUTE;
      var tdBodyIncrease = 1;
      ...
      var output = "td.exists(td.get(c, " + JSON.stringify(node.key) + ")).then(function(val) {\n        if (Array.isArray(val)) {\n          " + beforeLoop + "\n          for (var i=0, item; item=val[i]; i++) {\n            " + loopAction + "\n          }\n          " + afterLoop + "\n        } else {\n          " + notArrayAction + "\n        }\n      }.bind(this))";
  ...
  setHTMLElementState: function setHTMLElementState(nodeInfo) {
   ...
   * is needed)
   */
  adjustAttrName: function adjustAttrName(elType, attrName) {
...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c33 = function(start, h, bodies, end) {
        ...
        peg$c34 = function(start, h, bodies, end) {
            start.bodies = bodies;
            start.body = h;
        ...
        peg$c38 = function(type, h) {return ['TORNADO_BODY', {name: type, type: 'bodies', body: h}];},
        peg$c39 = function(b) {
            return b;
          },
        peg$c40 = /^[#?\^<+@%]/,
        ...
        peg$c58 = function(key, val) {return {key: key, val: val}},
        peg$c59 = /^[#?\^><+%:@\/~%]/,
        ...
        peg$c79 = /^[\t\x0B\f\n \xA0\uFEFF]/,
        peg$c80 = { type: "class", value: "[\\t\\x0B\\f\\n \\xA0\\uFEFF]", description: "[\\t\\x0B\\f\\n \\xA0\\uFEFF]" },
        peg$c81 = "</",
...
var tornado = {
   ...
   */
  fetchPartial: function fetchPartial(name) {
    return new Promise(function (resolve, reject) {
...
},{"../../dist/compiler":1,"../../dist/parser":2,"../../dist/runtime":3}]},{},[4]);
