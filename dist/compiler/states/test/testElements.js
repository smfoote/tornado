...
test("body and elements nested", function (t) {
  ...
  t.equal(api.entities.elements.filter(function (el) {
    return el.type === "element";
  }).length, 3, "adding 3 elements to the list of elements");
  t.equal(api.entities.elements.filter(function (el) {
    return el.type === "placeholder";
  }).length, 2, "adding 2 placeholders to the list of elements");
